...
type
  TForm1 = class(TForm)
    ...
    procedure ÞifreKeyPress(Sender: TObject; var Key: Char);
...
begin
  ...
  ADOQuery1.SQL.Clear;
  ADOQuery1.SQL.Add('select * from kullanici_hesabi where kullanici_adi='''+kullaniciadi.Text+''' and sifre='''+Þifre.Text+'''');
  ADOQuery1.Open;
...
procedure TForm1.ÞifreKeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 then  begin
    Button1.Click;
  end;
