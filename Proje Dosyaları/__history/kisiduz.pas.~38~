...
begin
    ADOQuery1.SQL.Clear;
    ADOQuery1.SQL.Add('select hst.adi as ''has_adi'',ak.id as ''ak_idd'',hst.id as ''ht_idd'',hst.soyadi as ''has_soyadi'',hst.kimlik_no,hst.adres,hst.gsm as ''has_gsm'',hst.mail as ''has_mail'',cinsiyet,ak.adi,ak.soyadi,ak.yakýnlýk,ak.gsm,ak.mail');
    ...
    MaskEdit13.Text:=ADOQuery1.FieldByName('yakýnlýk').AsString;
...
begin
  ADOQuery1.SQL.Clear; // akraba veri giriþi
  ADOQuery1.SQL.Add('update akraba set adi='+#39+MaskEdit11.Text+#39+', soyadi='+#39+MaskEdit12.Text+#39+', yakýnlýk='+#39+MaskEdit13.Text+#39+', gsm='+#39+MaskEdit14.Text+#39+',mail='+#39+MaskEdit15.Text+#39+' where id='+ak_id.ToString+'');
  ADOQuery1.ExecSQL;
