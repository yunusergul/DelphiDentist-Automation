object Form9: TForm9
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select * from kullanici_hesabi h join kullanini_rolu r on r.kull' +
        'anici_hesabi_id=h.id where h.yetki_id=2')
    Left = 224
  end
  object aramaQuery: TADOQuery
    Active = True
    Connection = ADOConnection1
    CursorType = ctStatic
    Parameters = <>
